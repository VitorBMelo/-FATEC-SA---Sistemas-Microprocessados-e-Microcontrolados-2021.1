...
#define NOME_DA_REDE "Vitor"
#define SENHA_DA_REDE "lajegrande"
...
void loop() {
  ...
  if ((WiFiMulti.run() == WL_CONNECTED)) {
    ...
    const char* site = "http://192.168.0.24:1880/ola";
    tratarRequisicaoGetHttp(site);
    delay(1000);
    tratarRequisicaoGetHttp("http://192.168.0.24:1880/ola-nome?nome=Vitor");
  }
  delay(10000);
}
